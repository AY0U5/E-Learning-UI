...
@Component({
    selector: 'app-etat-section-edit-admin',
    templateUrl: './etat-section-edit-admin.component.html'
})
export class EtatSectionEditAdminComponent extends AbstractEditController<EtatSectionDto, EtatSectionCriteria, EtatSectionAdminService>   implements OnInit {
