...
@Component({
    selector: 'app-etat-parcours-create-admin',
    templateUrl: './etat-parcours-create-admin.component.html'
})
export class EtatParcoursCreateAdminComponent extends AbstractCreateController<EtatParcoursDto, EtatParcoursCriteria, EtatParcoursAdminService>  implements OnInit {
