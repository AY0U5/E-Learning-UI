...
export class EtatEtudiantScheduleCreateAdminComponent extends AbstractCreateController<EtatEtudiantScheduleDto, EtatEtudiantScheduleCriteria, EtatEtudiantScheduleAdminService>  implements OnInit {
