...
export class ClassAverageBonusProfEditAdminComponent extends AbstractEditController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfAdminService>   implements OnInit {
