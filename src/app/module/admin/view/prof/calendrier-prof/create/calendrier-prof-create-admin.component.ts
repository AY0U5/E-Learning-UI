...
export class CalendrierProfCreateAdminComponent extends AbstractCreateController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfAdminService>  implements OnInit {
